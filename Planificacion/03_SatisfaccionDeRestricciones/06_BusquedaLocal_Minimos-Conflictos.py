"""
El algoritmo de búsqueda local para resolver problemas de "Mínimos Conflictos" es una técnica 
utilizada para encontrar soluciones en problemas de satisfacción de restricciones (CSP, por sus siglas en inglés). 
Este código resuelve el problema de las N-Queens utilizando el algoritmo de Mínimos Conflictos.
Ajusta el valor de n en la parte superior del script para cambiar el tamaño del tablero y encontrar soluciones 
