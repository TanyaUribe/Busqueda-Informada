"""
El algoritmo de Salto Atrás Dirigido por Conflictos (Backjumping) es una técnica utilizada
en la resolución de problemas de satisfacción de restricciones (CSPs) que permite identificar
de manera eficiente cuál variable o asignación es responsable de un conflicto en la búsqueda.
Este código define una clase CSP para representar un problema de satisfacción de restricciones. 
