...
Este código define una función llamada funcion_de_utilidad que calcula la utilidad total de un consumidor 
dadas las cantidades de bienes consumidas y los precios de esos bienes. Puedes ajustar la elasticidad para 
cambiar la forma de la función de utilidad. En este ejemplo, se utiliza una función de utilidad Cobb-Douglas
con elasticidad de 1.5.

Puedes modificar las listas cantidades y precios, así como la elasticidad según tus necesidades para calcular
