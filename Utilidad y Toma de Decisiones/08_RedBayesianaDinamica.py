"""
Crear un código completo de una Red Bayesiana Dinámica (DBN) es un proyecto complejo que 
requeriría un lenguaje de programación específico y un contexto detallado.
Este código crea un modelo simple de una DBN con dos variables, A y B, en dos instantes 
de tiempo, t1 y t2. Define las CPD para las variables en cada instante de tiempo y luego 
realiza una consulta de inferencia para estimar la probabilidad de la variable A en t2 dado que B en t1 es 0.
"""
