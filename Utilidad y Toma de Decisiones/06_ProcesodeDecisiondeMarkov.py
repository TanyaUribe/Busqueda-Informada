"""
Un proceso de decisión de Markov (MDP) es un modelo matemático que se utiliza en el aprendizaje automático y 
la toma de decisiones secuenciales. 
Este código implementa un proceso de decisión de Markov simple con dos estados y dos acciones. A través de 
la iteración de valor, encuentra la política óptima y la muestra en la salida. 
"""
