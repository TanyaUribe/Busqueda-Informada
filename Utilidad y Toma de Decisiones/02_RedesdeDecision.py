"""
hemos creado una red de decisión simple que modela la decisión de si llevar una sombrilla
en función de si llueve, si hay tráfico y si llegas tarde. Luego, calculamos el valor esperado
de tomar la decisión de llevar una sombrilla. 
"""
