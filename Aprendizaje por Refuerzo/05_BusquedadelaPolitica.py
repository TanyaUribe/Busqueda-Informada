"""
Este código buscará las palabras clave de política en un texto dado. Puedes ajustar las palabras
clave de política según tus necesidades y aplicar este código a tus propios documentos o textos. 
Asegúrate de proporcionar un texto real en lugar de sample_text para que la búsqueda de política 
sea efectiva.
"""
