"""
El aprendizaje por refuerzo activo es una rama de la inteligencia artificial que implica que un agente 
(como un programa informático) aprenda a tomar decisiones óptimas para maximizar una recompensa a lo largo del tiempo. 
Este código implementa el algoritmo Q-learning para el entorno CartPole de OpenAI Gym. El agente aprende a equilibrar
un poste en un carrito, y el objetivo es maximizar la recompensa. Ten en cuenta que este es un ejemplo simple, y el 
aprendizaje por refuerzo activo puede ser mucho más complejo en aplicaciones del mundo real. Ajusta los parámetros y 
el entorno según tus necesidades específicas.
