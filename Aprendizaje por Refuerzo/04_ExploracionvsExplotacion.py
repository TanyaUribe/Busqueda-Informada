"""
Este código implementa un algoritmo epsilon-greedy para equilibrar la exploración (con 
probabilidad epsilon) y la explotación (con probabilidad 1 - epsilon) en un problema de 
bandit multi-armed. Puedes ajustar el valor de epsilon para controlar el equilibrio entre 
exploración y explotación. Cuanto menor sea epsilon, más énfasis se pondrá en la explotación.

Ten en cuenta que en un entorno real, las recompensas verdaderas no serían conocidas, pero 
este ejemplo las simula para ilustrar el concepto. En la práctica, tendrías que adaptar el 
algoritmo para aprender de las recompensas observadas.
